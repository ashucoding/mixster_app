...
class DrinksTest < ApplicationSystemTestCase
  ...
  test "creating a Drink" do
    ...
    fill_in "Bar location", with: @drink.bar_location
    fill_in "Bar name", with: @drink.bar_name
    fill_in "Bartender", with: @drink.bartender
    fill_in "Ingredients", with: @drink.ingredients
    fill_in "Name", with: @drink.name
    fill_in "Taste", with: @drink.taste
